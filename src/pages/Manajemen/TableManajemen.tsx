...
const TableManajemen = ({ searchQuery }: any) => {
    ...
    confirmDialog({
      message: (
        <span style={{ fontSize: '12px', wordWrap: 'break-word' }}>
          Apakah anda yakin ingin menghapus data karyawan ini? Tindakan ini tidak
          dapat dibatalkan
        </span>
      ),
      header: 'Hapus data karyawan',
      icon: (
  ...
  const handleEdit = (data: any) => {
    navigate('/tambah-karyawan', { state: { data } });
  };

  const handleTambah = (data: any) => {
    navigate('/tambah-penilaian', { state: { data, form: 1 } });
  };

  const handleLihat = (data: any) => {
    navigate('/tambah-penilaian', { state: { data, form: 2 } });
  };
  return (
      ...
      <div className="flex flex-col">
        <div className="grid grid-cols-6 rounded-sm bg-[#24A3C4] text-white dark:bg-meta-4">
          ...
          <div className="p-2 text-center">
            <h5 className="text-sm font-medium uppercase">Nama</h5>
          </div>
          <div className="p-2 text-center">
            <h5 className="text-sm font-medium uppercase">Posisi</h5>
          </div>
          <div className="p-2 text-center">
            <h5 className="text-sm font-medium uppercase">Form</h5>
          </div>
          <div className="p-2 text-center">
            <h5 className="text-sm font-medium uppercase">Penilaian</h5>
          </div>
          <div className="p-2 text-center">
            <h5 className="text-sm font-medium uppercase">Aksi</h5>
          </div>
        </div>
