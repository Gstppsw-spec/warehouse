...
const initialDataPenyimpanan: PENYIMPANAN[] = [
  {
    ...
    kode: '1A',
    name: 'Barang A',
    penanggungJawab: 'Ucok',
    idPenanggungJawab: 1,
    status: 'Belum diambil',
    idStatus: 1,
    imageLink: "https://down-id.img.susercontent.com/file/id-11134207-7r992-lvscmsmffrz2e9",
  },
  {
    id: 2,
    kode: '2A',
    name: 'Barang B',
    penanggungJawab: 'Butet',
    idPenanggungJawab: 2,
    status: 'Belum diambil',
    idStatus: 2,
     imageLink: "https://down-id.img.susercontent.com/file/id-11134207-7r992-lvscmsmffrz2e9",
...
const TableStatus = ({searchQuery}: any) => {
  ...
  const handleEdit = (data: any) => {
    navigate('/edit-status', { state: { data } });
  };
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-col">
        <div className="grid grid-cols-5 rounded-sm bg-[#24A3C4] text-white dark:bg-meta-4">
          <div className="p-2">
            <h5 className="text-sm font-medium uppercase">Kode</h5>
          </div>
          <div className="p-2 text-center">
            <h5 className="text-sm font-medium uppercase">Nama Barang</h5>
          </div>
          <div className="p-2 text-center">
            <h5 className="text-sm font-medium uppercase">Penanggung Jawab</h5>
          </div>
          <div className="p-2 text-center">
