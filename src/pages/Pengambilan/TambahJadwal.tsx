...
export const TambahJadwal = () => {
  ...
  console.log(data?.idEkspedisi, 'm');
  ...
  const {
    ...
    defaultValues: {
      ...
      name: data?.name,
      kode: data?.kode,
      jadwalPengambilan: data?.jadwalPengambilan,
    ...
    confirmDialog({
      message: (
        <span style={{ fontSize: '12px', wordWrap: 'break-word' }}>
          Jadwal pengambilan berhasil ditambahkan. 
        </span>
      ),
      header: 'Berhasil membuat jadwal',
      icon: (
          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div className="border-b border-stroke py-4 px-6.5 dark:border-strokedark">
              <h3 className="font-medium text-black dark:text-white">
                Silahkan isi form untuk membuat jadwal pengambilan barang
              </h3>
            </div>
              ...
              <div className="p-6.5">
                <div className="mb-4.5 flex flex-row gap-9">
                  ...
                  <div className="w-1/2 flex flex-col gap-5">
                    <div>
                      <SelectEkspedisi
                        {...register('idEkspedisi')}
                        setValue={setValueForm}
                        kecId={data?.idEkspedisi}
                      />
                    </div>
