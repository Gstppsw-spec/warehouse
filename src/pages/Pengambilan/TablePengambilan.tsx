...
const TablePengambilan = ({searchQuery}: any) => {
  ...
  const handleEdit = (data: any) => {
    navigate('/tambah-jadwal', { state: { data } });
  };
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-col">
        <div className="grid grid-cols-6 rounded-sm bg-[#24A3C4] text-white dark:bg-meta-4">
          ...
          <div className="p-2 text-center">
            <h5 className="text-sm font-medium uppercase">Berat Barang</h5>
          </div>
          <div className="p-2 text-center">
            <h5 className="text-sm font-medium uppercase">Jadwal Pengambilan</h5>
          </div>
          <div className="p-2 text-center">
...
export default TablePengambilan;
